...
public class ChessMatch {
    ...
    private void initialSetup() {
        placeNewPiece('c', 1, new Rook(Color.BLUE, board));
        placeNewPiece('c', 2, new Rook(Color.BLUE, board));
        placeNewPiece('d', 2, new Rook(Color.BLUE, board));
        placeNewPiece('e', 2, new Rook(Color.BLUE, board));
        placeNewPiece('e', 1, new Rook(Color.BLUE, board));
        placeNewPiece('d', 1, new King(Color.BLUE, board));
